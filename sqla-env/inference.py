...
def main():
    ...
    print(json.dumps({
        "event": "END",
        "summary": {
            "task_easy": results.get("task_easy", {}).get("final_score", 0.0),
            "task_medium": results.get("task_medium", {}).get("final_score", 0.0),
            "task_hard": results.get("task_hard", {}).get("final_score", 0.0),
